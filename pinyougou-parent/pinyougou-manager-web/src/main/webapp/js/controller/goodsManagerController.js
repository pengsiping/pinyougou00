var app = new Vue({
    ...
    methods: {
        ...
        /*updateStatus:function (status) {
            axios.post('/goods/updateStatus.shtml',{params:{status:status},params:{ids:this.ids}}).then(function (response) {
                console.log(response);
                if(response.data.success){
                    app.searchList(1);
                }
        ...
        /*locationTo:function(id){
            location.href="'http://localhost:9102/admin/goods_edit.html?id='"+id;
        }*/
