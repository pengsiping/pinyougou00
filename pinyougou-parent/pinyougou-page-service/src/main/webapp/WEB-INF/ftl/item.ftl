            ...
            <div class="product-info">
                ...
                <div class="fr itemInfo-wrap">
                    ...
                    <div class="clearfix choose">
                        {{specificationItems}}
                        <#assign specficationList=tbGoodsDesc.specificationItems?eval />
                        ...
                        <div id="specification" class="summary-wrap clearfix">
                            ...
                            <dl>
                                ...
                                <dd>
                                    <#assign attributeValueList=item.attributeValue>
                                    <#list attributeValueList as value>
                                        <a href="javascript:;"
                                           :class="{selected:isSelect('${item.attributeName}','${value}')}"
                                           @click="selectSpec('${item.attributeName}','${value}')">${value}<span
                                                    title="点击取消选择">&nbsp;</span></a>
                                    </#list>
                                </dd>
                            </dl>
                            ...
                            <div class="fl title">
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <a href="javascript:void(0)" class="increment plus" @click="increase(1)">+</a>
                                        <a href="javascript:void(0)" class="increment mins" @click="increase(-1)">-</a>
                                    </div>
                                </div>
                            </div>
                            <div class="fl">
                ...
                <div class="fr detail">
                    ...
                    <div class="tab-main intro">
                        ...
                        <div class="tab-content tab-wraped">
                            ...
                            <#assign customAttributeItemsList=tbGoodsDesc.customAttributeItems?eval />
                            <#--[{"text":"内存大小","value":"32G"},{"text":"颜色","value":"黑色"}]-->
                            <div id="five" class="tab-pane">
                                <#list customAttributeItemsList as item>
                                    <#if item.value??>
