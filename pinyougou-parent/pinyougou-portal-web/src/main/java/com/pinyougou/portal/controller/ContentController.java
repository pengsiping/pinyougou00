...
public class ContentController {
	...
	@RequestMapping("/findAllCategory/{categoryId}")
    public List<TbContent> findAllCategory(@PathVariable (value = "categoryId")Long categoryId){
		return contentService.findAllCategory(categoryId);
	}
}
